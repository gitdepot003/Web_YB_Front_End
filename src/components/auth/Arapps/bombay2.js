...
const Bombay2 = () => {
  ...
  const playVideo4 = new URL("../../../images/comp/bombayvideo4.mp4", import.meta.url).toString();
  const playVideo5 = new URL("../../../images/comp/bombayvideo5.mp4", import.meta.url).toString();
  const playVideo6 = new URL("../../../images/comp/bombayvideo6.mp4", import.meta.url).toString();
  const playVideo7 = new URL("../../../images/comp/bombayvideo7.mp4", import.meta.url).toString();
  const playVideo8 = new URL("../../../images/comp/bombayvideo8.mp4", import.meta.url).toString();
  const playVideo9 = new URL("../../../images/comp/bombayvideo9.mp4", import.meta.url).toString();
  const playVideo10 = new URL("../../../images/comp/bombayvideo10.mp4", import.meta.url).toString();
